...
describe('getJobId()', () => {
    ...
    it('finds  id of a job with 2 node versions and 3 os - macos 14', () => {
        ...
        expect(ubuntuFourteenJobId).to.be.equal(JOB_DATA.THREE_OS_TWO_NODES.RESULTS.UBUNTU_14);
    });
    it('finds  id of a job with 2 node versions and 3 os - macos 12', () => {
        ...
        expect(ubuntuTwelveJobId).to.be.equal(JOB_DATA.THREE_OS_TWO_NODES.RESULTS.UBUNTU_12);
    });
    it('finds  id of a job with 2 node versions and 3 os - macos 14', () => {
        const args = {
            workflowJobs: parsedJsonData,
        ...
        expect(macosFourteenJobId).to.be.equal(JOB_DATA.THREE_OS_TWO_NODES.RESULTS.MACOS_14);
    });
    it('finds  id of a job with 2 node versions and 3 os - macos 12', () => {
        const args = {
            workflowJobs: parsedJsonData,
        ...
        expect(macosTwelveJobId).to.be.equal(JOB_DATA.THREE_OS_TWO_NODES.RESULTS.MACOS_12);
    });
    it('finds  id of a job with 2 node versions and 3 os - windows 14', () => {
        ...
        expect(windowsFourteenJobId).to.be.equal(JOB_DATA.THREE_OS_TWO_NODES.RESULTS.WINDOWS_14);
    });
    it('finds  id of a job with 2 node versions and 3 os - windows 12', () => {
        ...
        expect(windowsTwelveJobId).to.be.equal(JOB_DATA.THREE_OS_TWO_NODES.RESULTS.WINDOWS_12);
    });
